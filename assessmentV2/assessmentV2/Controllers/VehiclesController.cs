...
using assessmentV2.Models;

namespace assessmentV2.Controllers
{
    public class VehiclesController : Controller
    {
        private readonly PuntonetdbContext _context;

        public VehiclesController(PuntonetdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PuntonetdbContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
